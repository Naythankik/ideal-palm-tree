...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const content = 'Click the button below to verify your email address and finish your account.';
        ...
        const htmlBody =`
            ...
            `
        await sendMail("Request Verification Mail", htmlBody, email);
    ...
    res.status(200).send({
        message: "Verification Mail has been sent to the provided email!",
